...
/**
 * Created by MoriartyGG on 28.05.2018.
 */

public class SingleSpinnerSearch extends android.support.v7.widget.AppCompatSpinner implements DialogInterface.OnCancelListener {
    private static final String TAG = SingleSpinnerSearch.class.getSimpleName();
    private List<KeyPairBoolData> items;
    private String defaultText = "";
    private String spinnerTitle = "";
    private MultiSpinnerSearch.SpinnerListener listener;
    MyAdapter adapter;
    ...
    public void setItems(List<KeyPairBoolData> items, int position, MultiSpinnerSearch.SpinnerListener listener) {
